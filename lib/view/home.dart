...
import 'package:ml_image_detection/model/face_model.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget _imageView() {
    return Expanded(
      child: Container(
        ...
        decoration: CustomeTheme(widget.isDark).boxDecoration.copyWith(
  ...
  Widget _buildSlider() {
    return Container(
      ...
      decoration: CustomeTheme(widget.isDark).boxDecoration,
      child: Column(
        children: [
          Padding(
          ...
          SizedBox(
            ...
            child: RangeSlider(
              ...
              inactiveColor: CustomeTheme(widget.isDark).shadowColor,
